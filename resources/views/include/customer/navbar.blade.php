                        ...
                        <div>
                            <button type="button" class="flex rounded-full" aria-expanded="false"
                                ...
                                <div class="flex items-center gap-2 group">
                                    <div class="block py-2 pl-3 pr-4 text-slate-900 rounded group-hover:bg-slate-100 md:group-hover:bg-transparent md:border-0 md:group-hover:text-blue-700 md:p-0">Hello, {{ ucfirst(explode(' ', Auth::user()->name)[0]) }}</div>         
