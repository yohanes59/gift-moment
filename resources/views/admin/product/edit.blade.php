...
<div>
    <div class="flex gap-3 items-center">
        ...
        <div class="text-lg font-medium">Form Edit Produk</div>
    </div>
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="space-y-2">
                    ...
                    <div>
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="4" class="block p-2.5 w-full text-sm text-slate-900 bg-slate-50 rounded-md border border-slate-400">Lorem ipsum dolor sit amet.</textarea>
                    </div>
                </div>
