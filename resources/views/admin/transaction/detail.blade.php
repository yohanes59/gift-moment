...
@section('admin')
    <div class="mt-3">
        ...
        <div class="flex flex-col sm:flex-row gap-1 sm:gap-3 mb-4">
            ...
            <div class="flex flex-col bg-white border rounded-md p-3 space-y-2 cursor-pointer hover:brightness-50 duration-300" data-modal-target="buktiPembayaran" data-modal-toggle="buktiPembayaran" data-tooltip-target="bukti-bayar">
                ...
                <div class="w-fit h-fit mt-2">
                    ...
                    {{-- @if ($paymentData->where('transactions_id', $paymentData->id)->first() !== null) --}}
        ...
        <div class="relative w-full max-w-2xl max-h-full">
            <div class="relative bg-white rounded-lg shadow">
                <div class="flex items-start justify-between p-4 border-b rounded-t">
                    ...
                    <button type="button" class="text-red-500 bg-red-50 hover:bg-red-100 hover:text-red-700 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center duration-200" data-modal-hide="buktiPembayaran">
