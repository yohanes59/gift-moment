                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <form action="" method="POST">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-500">Apakah Anda yakin ingin menghapus kategori
                                ini?</h3>
                ...
                <tbody class="bg-white divide-y">
                    @foreach ($category as $item)
                        <tr class="divide-x">
                            ...
                            <td class="py-4 px-6">
                                <img src="{{ Storage::url($item->image) }}" alt="image {{ $item->name }}">
                            </td>
                            <td class="py-4 px-6">
                                {{ $item->name }}
                            </td>
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <form action="{{ url('admin/category/' . $item->id) }}" method="POST">
                                        ...
                                        <button type="submit"
                                            ...
                                            onclick="return('Ingin Menghapus data ini?')">
