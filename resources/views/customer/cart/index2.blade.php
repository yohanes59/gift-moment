    ...
    <div class="container mx-auto mt-20">
            ...
            <div class="flex my-10">
                <div class="w-3/4 bg-white px-10 py-10">
                    ...
                    <div class="flex mt-10 mb-5">
                        ...
                        <h3 class="font-semibold text-center text-slate-600 text-xs uppercase w-1/5 text-center">Quantity</h3>
                        <h3 class="font-semibold text-center text-slate-600 text-xs uppercase w-1/5 text-center">Harga</h3>
                        <h3 class="font-semibold text-center text-slate-600 text-xs uppercase w-1/5 text-center">Subtotal</h3>
                    </div>

                    @php $total = 0 @endphp
                    @foreach ($cart as $item)
                        <div class="flex items-center hover:bg-slate-100 py-5 bg-white border border-slate-200 mb-3 shadow-md">
                            <div class="flex w-2/5 gap-3 pl-6">
                                <!-- product -->
                                <div class="w-fit">
                                    <div class="w-16 md:w-24 h-16 md:h-24 rounded-md overflow-hidden">
                                        <img class="w-full h-full object-cover" src="{{ Storage::url($item->product->image) }}" alt="">
                                    </div>
                                </div>
                ...
                <div id="summary" class="w-1/4 px-4 lg:px-6 py-10 border border-slate-200 rounded-md shadow-lg fixed right-5">
        ...
        @else
            <div class="flex flex-col pt-24 justify-center items-center gap-4">
                ...
                <a href="{{ url('/') }}" class="px-8 py-3 text-center text-white font-semibold bg-indigo-500 rounded-md hover:opacity-80 duration-300">Ayo Belanja Sekarang</a>
            </div>
        @endif
    </div>
@endsection
