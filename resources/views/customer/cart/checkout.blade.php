                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex flex-col gap-3 border-b-2 border-indigo-200">
                        ...
                        <div class="w-full flex flex-col px-2">
                            ...
                            <div class="text-slate-500">Detail Alamat, Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aspernatur natus necessitatibus magni eveniet obcaecati voluptatum saepe culpa sed sunt quod!</div>
                            <div class="text-slate-500">Provinsi, Kabupaten, Kode Pos</div>

                            <div class="py-8">
                                <a href="/checkout/address/{{ Auth::user()->id }}" class="py-2 px-6 bg-white border-2 border-indigo-200 hover:bg-indigo-500 hover:border-indigo-500 hover:text-white duration-300 rounded-md font-medium text-center">
                            ...
                            <div class="w-full flex gap-3 px-2">
                                <div class="w-fit">
                                    <div class="w-32 h-32 rounded-md overflow-hidden">
                                        <img class="object-cover" src="{{ asset('assets/img/img-product.png') }}" alt="">
                                    </div>
                                </div>
                                <div class="flex flex-col py-2">
                                    <div>Nama Produk, Lorem ipsum dolor sit amet consectetur, adipisicing elit.</div>
                                    <div class="text-slate-500">Jumlah Produk</div>
                                    <div class="font-semibold">Rp Subtotal Produk</div>
                                </div>
                            </div>
                            {{-- data statis start --}}
                            <div class="w-full flex gap-3 px-2">
                    ...
                    <div class="flex flex-col gap-3 pb-6 border-b-2 border-indigo-200">
                        ...
                        <div class="w-full flex flex-col px-2">
                            ...
                            <div class="pt-6 pb-2">
                                <a href="{{ url('/checkout/courier') }}" class="py-2 px-6 bg-white border-2 border-indigo-200 hover:bg-indigo-500 hover:border-indigo-500 hover:text-white duration-300 rounded-md font-medium text-center">
                ...
                <div class="px-4 lg:px-6 py-4 border border-indigo-100 rounded-md shadow-lg shadow-indigo-100">
                    ...
                    <div class="flex flex-col gap-2 mt-4">
                        ...
                        <div class="py-4 border-t-2 border-indigo-300 flex flex-col gap-4">
                            ...
                            <div>
                                <button onclick="window.location.href='{{ url('/checkout') }}';" class="bg-indigo-500 font-bold hover:bg-indigo-600 py-3 text-sm text-white rounded-md w-full">
                                    Lanjut Pembayaran??
                                </button>
                            </div>
                        </div>
