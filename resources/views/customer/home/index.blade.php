                ...
                <div class="w-full max-w-sm lg:max-w-lg">
                    ...
                    <form action="{{ url('/search') }}" method="GET">   
                        ...
                        <div class="relative">
                            ...
                            <input name="search" type="search" value="{{ Request::get('search') }}" id="default-search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-indigo-500 focus:border-indigo-500" placeholder="Cari produk impianmu..." required>
                            <button type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-indigo-700 hover:bg-indigo-800 focus:ring-4 focus:outline-none focus:ring-indigo-300 font-medium rounded-lg text-sm px-4 py-2">
            ...
            <div class="flex flex-wrap gap-5 mt-3 mb-8">
                @foreach ($products as $item)
                    <a href="{{ url('/product/' . $item->slug) }}"
                        class="w-full max-w-[150px] md:max-w-[220px] lg:max-w-[290px] xl:max-w-[276px] flex flex-col gap-2 pb-2 border border-indigo-50 shadow-lg shadow-indigo-100 overflow-hidden rounded-md">
